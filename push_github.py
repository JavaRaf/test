...
def git_push_ids():
    ...
    try:
        ...
        subprocess.run(f'git pull origin {Data.git_this_branch}', shell=True, check=True)  
        ...
        subprocess.run(f'git push -u https://{Data.git_username}:{Data.git_tok}@github.com/{Data.git_username}/{Data.git_this_repo} {Data.git_this_branch}', shell=True, check=True)
